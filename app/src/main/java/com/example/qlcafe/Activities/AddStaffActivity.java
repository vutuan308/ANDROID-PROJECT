...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_addstaff_ThemNV) {
            ...
            int selectedGenderId = RG_addstaff_GioiTinh.getCheckedRadioButtonId();
            if (selectedGenderId == R.id.rd_addstaff_Nam) {
                gioiTinh = "Nam";
            } else if (selectedGenderId == R.id.rd_addstaff_Nu) {
                gioiTinh = "Nữ";
            } else if (selectedGenderId == R.id.rd_addstaff_Khac) {
                gioiTinh = "Khác";
            }

            int selectedPermissionId = rg_addstaff_Quyen.getCheckedRadioButtonId();
            if (selectedPermissionId == R.id.rd_addstaff_QuanLy) {
                quyen = 1;
            } else if (selectedPermissionId == R.id.rd_addstaff_NhanVien) {
                quyen = 2;
            }

            int day = DT_addstaff_NgaySinh.getDayOfMonth();
            int month = DT_addstaff_NgaySinh.getMonth() + 1;
            int year = DT_addstaff_NgaySinh.getYear();
            ngaySinh = String.format(Locale.getDefault(), "%02d/%02d/%04d", day, month, year);
            ...
            // Thêm, sửa nhân viên dựa theo obj nhanvienDTO
