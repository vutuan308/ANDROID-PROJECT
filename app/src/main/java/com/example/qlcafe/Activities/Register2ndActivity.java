    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int selectedGenderId = RG_signup_GioiTinh.getCheckedRadioButtonId();
                if (selectedGenderId == R.id.rd_signup_Nam) {
                    gioiTinh = "Nam";
                } else if (selectedGenderId == R.id.rd_signup_Nu) {
                    gioiTinh = "Nữ";
                } else if (selectedGenderId == R.id.rd_signup_Khac) {
                    gioiTinh = "Khác";
                }
                ...
                // Nếu nhân viên đầu tiên đăng ký, cấp quyền quản lý
                ...
                // Thêm nhân viên dựa theo obj nhanvienDTO
